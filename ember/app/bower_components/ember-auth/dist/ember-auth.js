...
set$(get$(Em, 'Auth'), 'Request', Ember.Object.extend({
  init: function () {
      //log.debug('ember-auth.Auth.Request.init');
    var adapter;
  ...
  syncEvent: function () {
      //log.debug('ember-auth.Auth.Request.syncEvent');
  ...
  signIn: function (url, opts) {
      //log.debug('ember-auth.Auth.Request.signIn');
    var this$;
  ...
  signOut: function (url, opts) {
      //log.debug('ember-auth.Auth.Request.signOut');
    var this$;
    return get$(this, 'auth').ensurePromise((this$ = this, function () {
  ...
  send: function (opts) {
      //log.debug('ember-auth.Auth.Request.send');
    var this$;
    return get$(this, 'auth').ensurePromise((this$ = this, function () {
  ...
  resolveUrl: function (path) {
      //log.debug('ember-auth.Auth.Request.resolveUrl');
    var base;
  ...
  inject: function () {
      //log.debug('ember-auth.Auth.Request.inject');
    var this$, this$1, this$2;
    return get$(this, 'auth').reopen({
      signIn: (this$ = this, function (opts) {
          var url = this$.resolveUrl(get$(get$(this$, 'auth'), 'signInEndPoint'));
          var opts = this$.injectAPI(url,opts);
        return this$.signIn(opts.url,opts);
      }),
      signOut: (this$1 = this, function (opts) {
          var url = this$1.resolveUrl(get$(get$(this$1, 'auth'), 'signOutEndPoint'));
          var opts = this$1.injectAPI(url,opts);
          return this$1.signOut(opts.url,opts);
      }),
      send: (this$2 = this, function (opts) {
        return this$2.send(this$2.injectAPI(opts));
      })
    });
  }
}));// Generated by EmberScript 0.0.7
...
set$(get$(get$(Em, 'Auth'), 'Request'), 'Dummy', Ember.Object.extend({
  signIn: function (url, opts) {
      //log.debug('ember-auth.Auth.Request.Dummy.signIn');
    if (null == opts)
      opts = {};
    this.send(opts);
  ...
  signOut: function (url, opts) {
      //log.debug('ember-auth.Auth.Request.Dummy.signOut');
    if (null == opts)
      opts = {};
    this.send(opts);
    switch (get$(opts, 'status')) {
  ...
  send: function (opts) {
      //log.debug('ember-auth.Auth.Request.Dummy.send');
    if (null == opts)
      opts = {};
...
void function () {
  ...
  set$(get$(get$(Em, 'Auth'), 'Request'), 'Jquery', Ember.Object.extend({
    init: function () {
        //log.debug('ember-auth.Auth.Request.Jquery.init');
      null != get$(this, 'jqxhr') || set$(this, 'jqxhr', null);
      return this.inject();
    },
    signIn: function (url, opts) {
        //log.debug('ember-auth.Auth.Request.Jquery.signIn');
      var this$, this$1, this$2;
      if (null == opts)
        opts = {};
    ...
    signOut: function (url, opts) {
        //log.debug('ember-auth.Auth.Request.Jquery.signOut');
      var this$, this$1, this$2;
      if (null == opts)
        opts = {};
      return this.send($.extend(true, {
    ...
    send: function (settings) {
        //log.debug('ember-auth.Auth.Request.Jquery.send');
    ...
    inject: function () {
        //log.debug('ember-auth.Auth.Request.Jquery.inject');
      var this$;
      return get$(this, 'auth').reopen({
...
set$(get$(Em, 'Auth'), 'Response', Ember.Object.extend({
  init: function () {
      //log.debug('ember-auth.Auth.Response.init');
    var adapter;
  ...
  syncEvent: function () {
      //log.debug('ember-auth.Auth.Response.syncEvent');
    if (null != get$(get$(this, 'adapter'), 'syncEvent'))
      return get$(get$(this, 'adapter'), 'syncEvent').apply(get$(this, 'adapter'), arguments);
  },
  canonicalize: function (input) {
      //log.debug('ember-auth.Auth.Response.canonicalize');
    return set$(this, 'response', get$(this, 'adapter').canonicalize(input));
  },
  inject: function () {
      //log.debug('ember-auth.Auth.Response.inject');
    var this$;
    return get$(this, 'auth').reopen({
...
set$(get$(get$(Em, 'Auth'), 'Response'), 'Dummy', Ember.Object.extend({
  canonicalize: function (input) {
      //log.debug('ember-auth.Auth.Response.Dummy.canonicalize');
    return input;
  }
}));// Generated by EmberScript 0.0.7
var get$ = Ember.get;
...
set$(get$(get$(Em, 'Auth'), 'Response'), 'Json', Ember.Object.extend({
  canonicalize: function (input) {
      //log.debug('ember-auth.Auth.Response.Json.canonicalize');
    var error;
    if (!input)
      return {};
    switch (typeof input) {
...
set$(get$(Em, 'Auth'), 'Strategy', Ember.Object.extend({
  init: function () {
      //log.debug('ember-auth.Auth.Strategy.init');
    var adapter;
    if (!(null != get$(this, 'adapter'))) {
  ...
  syncEvent: function (name, args) {
      //log.debug('ember-auth.Auth.Strategy.syncEvent');
  ...
  serialize: function (opts) {
      //log.debug('ember-auth.Auth.Strategy.serialize');
...
set$(get$(get$(Em, 'Auth'), 'Strategy'), 'Token', Ember.Object.extend({
  init: function () {
      //log.debug('ember-auth.Auth.Strategy.Token.init');
    null != get$(this, 'authToken') || set$(this, 'authToken', null);
    return this.inject();
  },
  serialize: function (opts) {
      //log.debug('ember-auth.Auth.Strategy.Token.serialize');
    if (null == opts)
      opts = {};
  ...
  deserialize: function (data) {
      //log.debug('ember-auth.Auth.Strategy.Token.deserialize');
    if (null == data)
      data = {};
...
set$(get$(Em, 'Auth'), 'Session', Ember.Object.extend({
  init: function () {
      //log.debug('ember-auth.Auth.Session.init');
...
//      return this$1.clear();
  ...
  findUser: function () {
      //log.debug('ember-auth.Auth.Session.findUser');
...
void function () {
  ...
  set$(get$(get$(Em, 'Auth'), 'Module'), 'ActionRedirectable', Ember.Object.extend({
    ...
    resolveRedirect: function (env) {
      if (!(env === 'signIn' || env === 'signOut')) return false;
      return this.get('' + env + 'Redir');
    },
    registerRedirect: function (transition) {
      var routeName = this.canonicalizeRoute(get$(transition, 'targetName'));
      if(typeof transition.queryParams != 'undefined' && transition.queryParams != null && transition.queryParams.hasOwnProperty('ret')){
          set$(this, 'signInRedir', transition.queryParams);
      }else if ($.inArray(routeName, this.getBlacklist('signIn')) === -1){
...
set$(get$(get$(Em, 'Auth'), 'Module'), 'AuthRedirectable', Ember.Object.extend({
  init: function () {
      //log.debug('ember-auth.Auth.Module.AuthRedirectable.init');
    null != get$(this, 'config') || set$(this, 'config', get$(get$(this, 'auth'), 'authRedirectable'));
    return this.patch();
  },
  patch: function () {
      //log.debug('ember-auth.Auth.Module.AuthRedirectable.patch');
    var self;
    self = this;
    set$(this, 'AuthRedirectable', Ember.Mixin.create({
      beforeModel: function () {
          //log.debug('ember-auth.Auth.Module.AuthRedirectable.beforeModel');
        var this$;
