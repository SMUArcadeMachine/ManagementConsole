...
//            $('.topDash').addClass('icon-white');
//        },
//        function(){
//            $('.topDash').removeClass('icon-white');
//        });
//    $('.middlemanLink').hover(function(){
//            $('.topMM').addClass('icon-white');
//        },
//        function(){
//            $('.topMM').removeClass('icon-white');
//        });
//    $('.createListingLink').hover(function(){
//            $('.topCL').addClass('icon-white');
//        },
//        function(){
//            $('.topCL').removeClass('icon-white');
//        });

});
function passResponse(){
//    $('.navbar-form-real .username').val(md5($('.navbar-form .username').val()));
//    $('.navbar-form-real .password').val(md5($('.navbar-form .password').val()));
//    $('.navbar-form-real').submit();
    $('.navbar-form').submit();
}
