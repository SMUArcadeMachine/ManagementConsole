...
|--------------------------------------------------------------------------
|
| Should the service do http authentication too?
|
|	Default: FALSE
|
*/
$config['rest_enable_http_authentication'] = FALSE;
...
| example:
|
|			$config['auth_override_class_method']['deals']['view'] = true;
|			$config['auth_override_class_method']['deals']['insert'] = 'digest';
|			$config['auth_override_class_method']['accounts']['user'] = 'basic';
|			$config['auth_override_class_method']['accounts']['user'] = 'login';
|
...
$config['auth_override_class_method']['login']['create'] = true;
...
/*
|--------------------------------------------------------------------------
| REST Table ID Column Name
|--------------------------------------------------------------------------
|
| If you are not using the default table schema as shown above, what is the
| name of the db column that holds the ID value?
|
*/
$config['rest_id_column'] = 'id';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_key_cookie_name'] = 'ember-auth-rememberable';
